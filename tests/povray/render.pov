...
// 
AngleMarker(< -3.41,  -0.08,   0.00>, < -0.71,  -0.01,  -0.97>, <  3.36,   1.44,  -0.94>, 6.995929746675325)

Arrow(< -3.41,  -0.08,   0.00>, < -0.71,  -0.01,  -0.97>, 0.02, 0.01)

Arrow(<  3.36,   1.44,  -0.94>, < -3.41,  -0.08,   0.00>, 0.02, 0.01)
